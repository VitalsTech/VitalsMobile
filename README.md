...
- Видеозвонок на том же экране (камера + микрофон, чат во время звонка). DEV: WebRTC P2P, сигналинг SignalR.

### Консультации

- Список: активные / чаты / завершённые.
- Детали сессии + чат + видео на том же экране.
...
- Сообщения чата по-прежнему polling ~2 с; видеосигналинг — SignalR.
